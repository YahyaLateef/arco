...
<nav class="navbar navbar-expand-md  fixed-top black" style=" border-bottom: 1px solid rgba(255, 255, 255, 0.1)">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="margin-top: -8em;">
  <!-- Wrapper for slides -->
  <div class="carousel-inner">
    <div class="item active" style="width: 100%; height:auto;">
      <img src="assets/img/1-new.png" alt="11" class="car-image-best">
      <div class="carousel-caption">
        ...
        <p>Architek have been developing a transversal approach<br>combining architecture, urbanism and landscape.</p>
        <button type="button" class="btn btn-default">Discover Work</button>
        <div class="social4">
          <div class="row">
            <li>
    ...
    <div class="item" style="width: 100%; height:auto;">
      <img src="assets/img/2.jpg" alt="22" class="car-image-best">
      <div class="carousel-caption">
        <div class="logo-is-animetion">
          <h1>
    ...
    <div class="item" style="width: 100%; height:auto;">
      <img src="assets/img/3.jpg" alt="33" class="car-image-best">
      <div class="carousel-caption">
        <div class="logo-is-animetion">
          <h1>
    ...
    <div class="item" style="width: 100%; height: 910px !important;">
      <img src="assets/img/4.jpg" alt="44" style="height: 910px;">
      <div class="carousel-caption">
        <div class="logo-is-animetion">
          <h1>
...
<section class="animate-bottom" style="background-color: #f8f4f3;padding: 120px 0;">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card hover-img1 trap1" style="width: 100%">
          <div class="card-body">
      ...
      <div class="col-lg-4">
        ...
        <div class="card hover-img1 trap2" style="width: 100%;">
          <div class="card-body">
      ...
      <div class="col-lg-4">
        ...
        <div class="card hover-img1 trap3" style="width: 100%;">
          <div class="card-body">
...
<div class="wrap">  
  <div class="slider laali">
    
    <div class="item" style=" height:500px !important;">
      <img src="https://archo-react.vercel.app/assets/img/portfolio/metro/01.jpg" alt="">
      <div class="cont"><h6 class="tekofont">art & illustration</h6><h4 class="playfonts">Innovation and Crafts.</h4></div>
    </div>
    <div class="item" style=" height:500px !important;">
    ...
    <div class="item" style=" height:500px !important;">
      <img src="assets/img/grey.jpg" alt="">
      <div class="cont"><h6 class="tekofont">art & illustration</h6><h4 class="playfonts">Innovation and Crafts.</h4></div>
    </div>
    <div class="item" style=" height:500px !important;">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-5" style="margin-top: 6em;">
        <h2 class="play-cursive">What we<br>actually do</h2>
        <p style="color: #888;
        font-size: 15px;
        font-weight: 400;
        line-height: 2;
        margin: 0;">Architecture bibendum pharetra eleifend. Suspendisse vel<br>volutpat purus, sit amet bibendum nisl. mollis turpis a<br>ipsum ultes, nec condi mentum ipsum consequat. Mauris<br>vitae consequat nibh, vitae interdum mi.</p>
      </div>
      <div class="col-lg-4"  style="margin-top: 6em;">
        ...
        <div class="back-image"></div>
          <div class="circle">
            <i class="fa-solid fa-play" style="position: relative;
            top: 33px;
            left: 37px;
            font-size: 39px;
  ...
  <div class="bg-img-bath" style="background-image:url(assets/img/bath.jpg)"></div>
    <div class="container" style="margin-top: 10em;">
      <div class="head1" style="margin: 80px 0px;">
        <h6 class="tekofont">Best Work</h6>
        <h4 class="playfont">Drag the Slider to See<br>the Transformation One of the Interior</h4>
      </div>
      <div class="wrapper">
        <div class="images">
          <div class="img-1">
            <img style="max-width: 100%;" src="https://archo-react.vercel.app/assets/img/after.jpg" alt="">
          </div>
          <div class="img-2">
            <img src='https://archo-react.vercel.app/assets/img/before.jpg' class="resizeimg" alt="">
          </div>
        </div>
        <div class="slider">
          <div class="drag-line">
        ...
        <div class="line-pattern" style=" background-image: url(assets/img/line-pattern.png);
...
<section class="animate-bottom" style="padding: 120px 0;">
  <div class="container">
    <div class="row">
      <div class="col-lg-5">
        <div class="trat-56">
          <h6>Some thoughts from Us</h6>
          <h3>Our Employees</h3>
        </div>
        <div class="cont45">
          <p>We feel proud for our expert team members beatae ipsum<br>dolor sit amet, consectetur adipisicing elit mauris vita<br>consequat nibh, vitae interdum mi.</p>
          
        </div>
        
      </div>
      <div class="col-lg-7 but-next" >
        <div class="slider offerage" style="height: max-content;
        width: 140%;
        margin-top: 10px;">
          ...
          <div class="slide" style="margin-right: 20px;">
            <span>
              <img src="assets/img/author3.jpg"/>
              <div class="retro">
                <h5>Robert Front</h5>
                <span>CEO Founder</span>
                </div>
          ...
          <div class="slide" style="margin-right: 20px;">
            <span>
              <img src="assets/img/author4.jpg"/>
              <div class="retro">
                <h5>Robert Front</h5>
                <span>CEO Founder</span>
                </div>
    ...
    <div class="items toyi">
      <div>
        <div class="quote-icon1">
          <img src="assets/img/quote.svg" style="height: 100px;">
        </div>
        <div class="context2">
          <p>"I just love their design for all stunning details. You<br>must know what can you do for a project before<br>taking it, but with Archo, the sky is the limit."</p>
        </div>
        <div class="info43">
...
//adding width to fied image with the width respect to compare parent container on resize
...
$(window).scroll(function() {    
    ...
    if (scroll >= 300) {
        $(".nav-link").addClass("darkHeader");
    } else {
        $(".nav-link").removeClass("darkHeader");
    }
});
$(window).scroll(function() {    
    var scroll = $(window).scrollTop();
    ...
    if (scroll >= 300) {
        $(".dropdown-toggle").addClass("darkHeader");
    } else {
        $(".dropdown-toggle").removeClass("darkHeader");
    }
});
    </script>
    <script>
        $(function () { 
            $(window).scroll(function () {
                ...
                if ($(this).scrollTop() <300) { 
                    $('.navbar-brand img').attr('src','assets/img/logo-light (1).png');
                }
            })
        });
